...
module.exports = [{
    ...
    files: [
        ...
        // [RELAY-79/80/81/82] Terms of Service, Privacy Notice, DPA, Refund Policy.
        // Same reasoning as RELAY-60 above, applied to the same pre-launch,
        // single-locale surface: these are long-form legal copy, not app chrome, and
        // running them through next-i18next would mean hand-splitting a legal
        // document into dozens of translation keys with no second locale to justify
        // it. Reversible the same day Relay commits to a second locale.
