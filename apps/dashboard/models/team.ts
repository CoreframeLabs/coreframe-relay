...
export const createTeam = async (param: {
  ...
  // Was `findOrCreateApp` — Svix provisioned a per-team application to push events into.
  // Relay has no such external app to provision, so the useful half of that call (a record
  // that the team was created, and by whom) is all that survives.
